...
#define PWM_RIGHT_INIT_INTERRUPTS_MODE     (uint8)(((uint8)(0u << PWM_RIGHT_STATUS_TC_INT_EN_MASK_SHIFT)) | \
                                                  (uint8)((uint8)(0u << PWM_RIGHT_STATUS_CMP2_INT_EN_MASK_SHIFT)) | \
                                                  (uint8)((uint8)(0u << PWM_RIGHT_STATUS_CMP1_INT_EN_MASK_SHIFT )) | \
                                                  (uint8)((uint8)(0u << PWM_RIGHT_STATUS_KILL_INT_EN_MASK_SHIFT )))
#define PWM_RIGHT_DEFAULT_COMPARE2_MODE    (uint8)((uint8)1u << PWM_RIGHT_CTRL_CMPMODE2_SHIFT)
#define PWM_RIGHT_DEFAULT_COMPARE1_MODE    (uint8)((uint8)1u << PWM_RIGHT_CTRL_CMPMODE1_SHIFT)
...
******************************** */
    ...
    ***********************************/
    ...
    #define PWM_RIGHT_RT1_MASK              (uint8)((uint8)0x03u << PWM_RIGHT_RT1_SHIFT)/* Sync TC and CMP bit masks */
    #define PWM_RIGHT_SYNC                  (uint8)((uint8)0x03u << PWM_RIGHT_RT1_SHIFT)
    #define PWM_RIGHT_SYNCDSI_SHIFT         0x00u
    #define PWM_RIGHT_SYNCDSI_MASK          (uint8)((uint8)0x0Fu << PWM_RIGHT_SYNCDSI_SHIFT) /* Sync all DSI inputs */
    #define PWM_RIGHT_SYNCDSI_EN            (uint8)((uint8)0x0Fu << PWM_RIGHT_SYNCDSI_SHIFT) /* Sync all DSI inputs */
