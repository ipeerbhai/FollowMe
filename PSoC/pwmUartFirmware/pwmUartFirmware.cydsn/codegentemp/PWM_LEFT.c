...
void PWM_LEFT_Init(void) 
{
        ...
        ctrl = PWM_LEFT_CONTROL & ((uint8)(~PWM_LEFT_CTRL_CMPMODE2_MASK)) & ((uint8)(~PWM_LEFT_CTRL_CMPMODE1_MASK));
    ...
    /* Globally disable the Fixed Function Block chosen */
		...
		*******************************************************************************/
		void PWM_LEFT_SetCompareMode(uint8 comparemode) 
		{
		        ...
		        /*Clear existing mode */
		        PWM_LEFT_CONTROL &= ((uint8)(~(PWM_LEFT_CTRL_CMPMODE1_MASK | PWM_LEFT_CTRL_CMPMODE2_MASK))); 
...
void PWM_LEFT_WritePeriod(uint8 period) 
{
    ...
    *******************************************************************************/
    uint8 PWM_LEFT_ReadStatusRegister(void)   
    {
    	...
    	result = CY_GET_REG8(PWM_LEFT_STATUS_PTR);
    	return (result);
    }
