...
*
* Global variables:
*  PWM_RIGHT_initVar: Is modified when this function is called for the 
...
void PWM_RIGHT_Init(void) 
{
        ...
        uint8 ctrl;
    #endif /* (PWM_RIGHT_UsingFixedFunction || PWM_RIGHT_UseControl) */
        ...
        #endif /* (PWM_RIGHT_DeadBand2_4) */
                
        ctrl = PWM_RIGHT_CONTROL3 & ((uint8 )(~PWM_RIGHT_CTRL_CMPMODE1_MASK));
        PWM_RIGHT_CONTROL3 = ctrl | PWM_RIGHT_DEFAULT_COMPARE1_MODE;
        
         /* Clear and Set SYNCTC and SYNCCMP bits of RT1 register */
        PWM_RIGHT_RT1 &= ((uint8)(~PWM_RIGHT_RT1_MASK));
        PWM_RIGHT_RT1 |= PWM_RIGHT_SYNC;     
                
        /*Enable DSI Sync all all inputs of the PWM*/
        PWM_RIGHT_RT1 &= ((uint8)(~PWM_RIGHT_SYNCDSI_MASK));
        PWM_RIGHT_RT1 |= PWM_RIGHT_SYNCDSI_EN;
       
    #elif (PWM_RIGHT_UseControl)
        /* Set the default compare mode defined in the parameter */
        ctrl = PWM_RIGHT_CONTROL & ((uint8)(~PWM_RIGHT_CTRL_CMPMODE2_MASK)) & ((uint8)(~PWM_RIGHT_CTRL_CMPMODE1_MASK));
        PWM_RIGHT_CONTROL = ctrl | PWM_RIGHT_DEFAULT_COMPARE2_MODE | 
                                   PWM_RIGHT_DEFAULT_COMPARE1_MODE;
    #endif /* (PWM_RIGHT_UsingFixedFunction) */
...
void PWM_RIGHT_Enable(void) 
{
    ...
    #if (PWM_RIGHT_UsingFixedFunction)
        PWM_RIGHT_GLOBAL_ENABLE |= PWM_RIGHT_BLOCK_EN_MASK;
        PWM_RIGHT_GLOBAL_STBY_ENABLE |= PWM_RIGHT_BLOCK_STBY_EN_MASK;
    #endif /* (PWM_RIGHT_UsingFixedFunction) */
    
    /* Enable the PWM from the control register  */
    #if (PWM_RIGHT_UseControl || PWM_RIGHT_UsingFixedFunction)
        PWM_RIGHT_CONTROL |= PWM_RIGHT_CTRL_ENABLE;
    #endif /* (PWM_RIGHT_UseControl || PWM_RIGHT_UsingFixedFunction) */
}
...
{
    #if (PWM_RIGHT_UseControl || PWM_RIGHT_UsingFixedFunction)
        PWM_RIGHT_CONTROL &= ((uint8)(~PWM_RIGHT_CTRL_ENABLE));
    #endif /* (PWM_RIGHT_UseControl || PWM_RIGHT_UsingFixedFunction) */
    
    /* Globally disable the Fixed Function Block chosen */
    #if (PWM_RIGHT_UsingFixedFunction)
        PWM_RIGHT_GLOBAL_ENABLE &= ((uint8)(~PWM_RIGHT_BLOCK_EN_MASK));
        PWM_RIGHT_GLOBAL_STBY_ENABLE &= ((uint8)(~PWM_RIGHT_BLOCK_STBY_EN_MASK));
    #endif /* (PWM_RIGHT_UsingFixedFunction) */
}
		...
		*******************************************************************************/
		void PWM_RIGHT_SetCompareMode(uint8 comparemode) 
		{
                ...
                #if(0 != PWM_RIGHT_CTRL_CMPMODE1_SHIFT)
                    uint8 comparemodemasked = ((uint8)((uint8)comparemode << PWM_RIGHT_CTRL_CMPMODE1_SHIFT));
                #else
                    uint8 comparemodemasked = comparemode;
                #endif /* (0 != PWM_RIGHT_CTRL_CMPMODE1_SHIFT) */
            
	            PWM_RIGHT_CONTROL3 &= ((uint8)(~PWM_RIGHT_CTRL_CMPMODE1_MASK)); /*Clear Existing Data */
	            PWM_RIGHT_CONTROL3 |= comparemodemasked;     
		                
		    #elif (PWM_RIGHT_UseControl)
		        
                #if(0 != PWM_RIGHT_CTRL_CMPMODE1_SHIFT)
                    uint8 comparemode1masked = ((uint8)((uint8)comparemode << PWM_RIGHT_CTRL_CMPMODE1_SHIFT)) & 
    		                                    PWM_RIGHT_CTRL_CMPMODE1_MASK;
                #else
                    uint8 comparemode1masked = comparemode & PWM_RIGHT_CTRL_CMPMODE1_MASK;                
                #endif /* (0 != PWM_RIGHT_CTRL_CMPMODE1_SHIFT) */
                
                #if(0 != PWM_RIGHT_CTRL_CMPMODE2_SHIFT)                            
    		        uint8 comparemode2masked = ((uint8)((uint8)comparemode << PWM_RIGHT_CTRL_CMPMODE2_SHIFT)) & 
    		                                   PWM_RIGHT_CTRL_CMPMODE2_MASK;
                #else
    		        uint8 comparemode2masked = comparemode & PWM_RIGHT_CTRL_CMPMODE2_MASK;                
                #endif /* (0 != PWM_RIGHT_CTRL_CMPMODE2_SHIFT) */
                
		        /*Clear existing mode */
		        PWM_RIGHT_CONTROL &= ((uint8)(~(PWM_RIGHT_CTRL_CMPMODE1_MASK | PWM_RIGHT_CTRL_CMPMODE2_MASK))); 
		...
		*******************************************************************************/
		void PWM_RIGHT_SetCompareMode1(uint8 comparemode) 
		{
                ...
                uint8 comparemodemasked = ((uint8)((uint8)comparemode << PWM_RIGHT_CTRL_CMPMODE1_SHIFT)) & 
    		                               PWM_RIGHT_CTRL_CMPMODE1_MASK;
		    #else
                uint8 comparemodemasked = comparemode & PWM_RIGHT_CTRL_CMPMODE1_MASK;                
            #endif /* (0 != PWM_RIGHT_CTRL_CMPMODE1_SHIFT) */
                   
		    #if (PWM_RIGHT_UseControl)
		        PWM_RIGHT_CONTROL &= ((uint8)(~PWM_RIGHT_CTRL_CMPMODE1_MASK)); /*Clear existing mode */
    ...
    *******************************************************************************/
    void PWM_RIGHT_SetCompareMode2(uint8 comparemode) 
    {
        ...
        #if(0 != PWM_RIGHT_CTRL_CMPMODE2_SHIFT)
            uint8 comparemodemasked = ((uint8)((uint8)comparemode << PWM_RIGHT_CTRL_CMPMODE2_SHIFT)) & 
                                                 PWM_RIGHT_CTRL_CMPMODE2_MASK;
        #else
            uint8 comparemodemasked = comparemode & PWM_RIGHT_CTRL_CMPMODE2_MASK;            
        #endif /* (0 != PWM_RIGHT_CTRL_CMPMODE2_SHIFT) */
        
        #if (PWM_RIGHT_UseControl)
            PWM_RIGHT_CONTROL &= ((uint8)(~PWM_RIGHT_CTRL_CMPMODE2_MASK)); /*Clear existing mode */
            PWM_RIGHT_CONTROL |= comparemodemasked;
        #endif /* (PWM_RIGHT_UseControl) */
    }
    ...
    *******************************************************************************/
    ...
    {
        CY_SET_REG8(PWM_RIGHT_COUNTER_LSB_PTR, counter);
    }
    ...
    *******************************************************************************/
    uint8 PWM_RIGHT_ReadCounter(void) 
    {
        ...
        (void)PWM_RIGHT_COUNTERCAP_LSB;
        
        /* Read the data from the FIFO (or capture register for Fixed Function)*/
        return (CY_GET_REG8(PWM_RIGHT_CAPTURE_LSB_PTR));
    }
            ...
            *******************************************************************************/
            ...
            {
                while(0u != (PWM_RIGHT_ReadStatusRegister() & PWM_RIGHT_STATUS_FIFONEMPTY))
                {
                    (void)PWM_RIGHT_ReadCapture();
                }
            }
...
void PWM_RIGHT_WritePeriod(uint8 period) 
{
    ...
    #else
        CY_SET_REG8(PWM_RIGHT_PERIOD_LSB_PTR, period);
    #endif /* (PWM_RIGHT_UsingFixedFunction) */
}
    ...
    *******************************************************************************/
    ...
    {	
		...
		#else
	        CY_SET_REG8(PWM_RIGHT_COMPARE1_LSB_PTR, compare);	
		#endif /* (PWM_RIGHT_UsingFixedFunction) */
        
        #if (PWM_RIGHT_PWMMode == PWM_RIGHT__B_PWM__DITHER)
            #if(PWM_RIGHT_UsingFixedFunction)
    			CY_SET_REG16(PWM_RIGHT_COMPARE2_LSB_PTR, (uint16)(compare + 1u));
    		#else
    	        CY_SET_REG8(PWM_RIGHT_COMPARE2_LSB_PTR, (compare + 1u));	
    		#endif /* (PWM_RIGHT_UsingFixedFunction) */
        #endif /* (PWM_RIGHT_PWMMode == PWM_RIGHT__B_PWM__DITHER) */
    }
    ...
    *******************************************************************************/
                                        ...
                                        
    {
        ...
        #else
            CY_SET_REG8(PWM_RIGHT_COMPARE2_LSB_PTR, compare);
        #endif /* (PWM_RIGHT_UsingFixedFunction) */
    }
#endif /* UseOneCompareMode */
    ...
    *******************************************************************************/
    void PWM_RIGHT_WriteDeadTime(uint8 deadtime) 
    {
        /* If using the Dead Band 1-255 mode then just write the register */
            ...
            /* Clear existing data */
            PWM_RIGHT_DEADBAND_COUNT &= ((uint8)(~PWM_RIGHT_DEADBAND_COUNT_MASK));
            
            /* Set new dead time */
            #if(PWM_RIGHT_DEADBAND_COUNT_SHIFT)        
                PWM_RIGHT_DEADBAND_COUNT |= ((uint8)((uint8)deadtime << PWM_RIGHT_DEADBAND_COUNT_SHIFT)) & 
                                                    PWM_RIGHT_DEADBAND_COUNT_MASK;
            #else
                PWM_RIGHT_DEADBAND_COUNT |= deadtime & PWM_RIGHT_DEADBAND_COUNT_MASK;        
            #endif /* (PWM_RIGHT_DEADBAND_COUNT_SHIFT) */
    ...
    *******************************************************************************/
    uint8 PWM_RIGHT_ReadDeadTime(void) 
    {
        /* If using the Dead Band 1-255 mode then just read the register */
            ...
            /* Otherwise the data has to be masked and offset */
            #if(PWM_RIGHT_DEADBAND_COUNT_SHIFT)      
                return ((uint8)(((uint8)(PWM_RIGHT_DEADBAND_COUNT & PWM_RIGHT_DEADBAND_COUNT_MASK)) >> 
                                                                           PWM_RIGHT_DEADBAND_COUNT_SHIFT));
            #else
                return (PWM_RIGHT_DEADBAND_COUNT & PWM_RIGHT_DEADBAND_COUNT_MASK);
            #endif /* (PWM_RIGHT_DEADBAND_COUNT_SHIFT) */
        #endif /* (!PWM_RIGHT_DeadBand2_4) */
    }
#endif /* DeadBandUsed */
    ...
    /*******************************************************************************
    * Function Name: PWM_RIGHT_SetInterruptMode
    ********************************************************************************
    * 
    * Summary:
    ...
    *******************************************************************************/
    ...
    {
    	CY_SET_REG8(PWM_RIGHT_STATUS_MASK_PTR, interruptMode);
    }


    /*******************************************************************************
    * Function Name: PWM_RIGHT_ReadStatusRegister
    ********************************************************************************
    * 
    * Summary:
    ...
    *******************************************************************************/
    uint8 PWM_RIGHT_ReadStatusRegister(void)   
    {
    	...
    	result = CY_GET_REG8(PWM_RIGHT_STATUS_PTR);
    	return (result);
    }
    ...
    /*******************************************************************************
    * Function Name: PWM_RIGHT_ReadControlRegister
    ********************************************************************************
    * 
    * Summary:
    ...
    *******************************************************************************/    
    uint8 PWM_RIGHT_ReadControlRegister(void) 
    {
    	...
    	result = CY_GET_REG8(PWM_RIGHT_CONTROL_PTR);
    	return (result);
    }


    /*******************************************************************************
    * Function Name: PWM_RIGHT_WriteControlRegister
    ********************************************************************************
    * 
    * Summary:
    ...
    *******************************************************************************/  
    ...
    {
    	CY_SET_REG8(PWM_RIGHT_CONTROL_PTR, control);
    }
    ...
    /*******************************************************************************
    * Function Name: PWM_RIGHT_ReadCapture
    ********************************************************************************
    * 
    * Summary:
    ...
    *******************************************************************************/  
    ...
    /*******************************************************************************
    * Function Name: PWM_RIGHT_ReadCompare
    ********************************************************************************
    * 
    * Summary:
    ...
    *******************************************************************************/  
    ...
    {
		#if(PWM_RIGHT_UsingFixedFunction)
            return ((uint8)CY_GET_REG16(PWM_RIGHT_COMPARE1_LSB_PTR));
        #else
            return (CY_GET_REG8(PWM_RIGHT_COMPARE1_LSB_PTR));
        #endif /* (PWM_RIGHT_UsingFixedFunction) */
    }
    ...
    /*******************************************************************************
    * Function Name: PWM_RIGHT_ReadCompare1
    ********************************************************************************
    * 
    * Summary:
    ...
    *******************************************************************************/  
    ...
    /*******************************************************************************
    * Function Name: PWM_RIGHT_ReadCompare2
    ********************************************************************************
    * 
    * Summary:
    ...
    *******************************************************************************/  
    ...
    {
		return (CY_GET_REG8(PWM_RIGHT_COMPARE2_LSB_PTR));
    }
...
/*******************************************************************************
* Function Name: PWM_RIGHT_ReadPeriod
********************************************************************************
* 
* Summary:
...
{
	#if(PWM_RIGHT_UsingFixedFunction)
        return ((uint8)CY_GET_REG16(PWM_RIGHT_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG8(PWM_RIGHT_PERIOD_LSB_PTR));
    #endif /* (PWM_RIGHT_UsingFixedFunction) */
}
    ...
    /*******************************************************************************
    * Function Name: PWM_RIGHT_WriteKillTime
    ********************************************************************************
    * 
    * Summary:
    ...
    *******************************************************************************/ 
    ...
    {
    	CY_SET_REG8(PWM_RIGHT_KILLMODEMINTIME_PTR, killtime);
    }


    /*******************************************************************************
    * Function Name: PWM_RIGHT_ReadKillTime
    ********************************************************************************
    * 
    * Summary:
    ...
    *******************************************************************************/ 
    ...
    {
    	return (CY_GET_REG8(PWM_RIGHT_KILLMODEMINTIME_PTR));
    }
