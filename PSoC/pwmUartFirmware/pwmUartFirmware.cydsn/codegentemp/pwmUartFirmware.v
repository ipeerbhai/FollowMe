// ======================================================================
// pwmUartFirmware.v generated from TopDesign.cysch
// 07/27/2014 at 14:32
...
// PWM_v3_0(CaptureMode=0, Compare1_16=false, Compare1_8=true, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=127, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=255, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TriggerMode=0, UDB16=false, UDB8=true, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP8, CY_COMPONENT_NAME=PWM_v3_0, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=PWM_RIGHT, CY_INSTANCE_SHORT_NAME=PWM_RIGHT, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=PWM_RIGHT, )
module PWM_v3_0_1 (
    pwm2,
    tc,
    clock,
...
module top ;
    ...
    CyControlReg_v1_70 controlRegStep (
        .control_1(Net_124),
        .control_2(Net_103),
        .control_3(Net_104),
        .control_0(Net_119),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam controlRegStep.Bit0Mode = 0;
    defparam controlRegStep.Bit1Mode = 0;
    defparam controlRegStep.Bit2Mode = 0;
    defparam controlRegStep.Bit3Mode = 0;
    defparam controlRegStep.Bit4Mode = 0;
    defparam controlRegStep.Bit5Mode = 0;
    defparam controlRegStep.Bit6Mode = 0;
    defparam controlRegStep.Bit7Mode = 0;
    defparam controlRegStep.BitValue = 3;
    defparam controlRegStep.BusDisplay = 0;
    defparam controlRegStep.ExtrReset = 0;
    defparam controlRegStep.NumOutputs = 2;


    assign Net_120 = Net_119 & Net_118;


    assign Net_126 = Net_125 & Net_124;

    SCB_P4_v1_10_2 usbUART115200bps (
        .sclk(Net_184),
        .interrupt(Net_185),
        .clock(1'b0));

	wire [0:0] tmpOE__pinLeftStep_net;
	wire [0:0] tmpFB_0__pinLeftStep_net;
	wire [0:0] tmpIO_0__pinLeftStep_net;
	wire [0:0] tmpINTERRUPT_0__pinLeftStep_net;
	electrical [0:0] tmpSIOVREF__pinLeftStep_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  ...
		  .width(1))
		pinLeftStep
		 (.oe(tmpOE__pinLeftStep_net),
		  .y({Net_120}),
		  .fb({tmpFB_0__pinLeftStep_net[0:0]}),
		  .io({tmpIO_0__pinLeftStep_net[0:0]}),
		  .siovref(tmpSIOVREF__pinLeftStep_net),
		  .interrupt({tmpINTERRUPT_0__pinLeftStep_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pinLeftStep_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pinRightStep_net;
	wire [0:0] tmpFB_0__pinRightStep_net;
	wire [0:0] tmpIO_0__pinRightStep_net;
	wire [0:0] tmpINTERRUPT_0__pinRightStep_net;
	electrical [0:0] tmpSIOVREF__pinRightStep_net;

	cy_psoc3_pins_v1_10
		#(.id("87568ce8-ceeb-4d21-a1b3-cf5c29f47027"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .width(1))
		pinRightStep
		 (.oe(tmpOE__pinRightStep_net),
		  .y({Net_126}),
		  .fb({tmpFB_0__pinRightStep_net[0:0]}),
		  .io({tmpIO_0__pinRightStep_net[0:0]}),
		  .siovref(tmpSIOVREF__pinRightStep_net),
		  .interrupt({tmpINTERRUPT_0__pinRightStep_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pinRightStep_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pinLeftDir_net;
	wire [0:0] tmpFB_0__pinLeftDir_net;
	wire [0:0] tmpIO_0__pinLeftDir_net;
	wire [0:0] tmpINTERRUPT_0__pinLeftDir_net;
	electrical [0:0] tmpSIOVREF__pinLeftDir_net;

	cy_psoc3_pins_v1_10
		#(.id("dd340f94-f2e0-4246-9fff-ecbea168152f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .width(1))
		pinLeftDir
		 (.oe(tmpOE__pinLeftDir_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__pinLeftDir_net[0:0]}),
		  .io({tmpIO_0__pinLeftDir_net[0:0]}),
		  .siovref(tmpSIOVREF__pinLeftDir_net),
		  .interrupt({tmpINTERRUPT_0__pinLeftDir_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pinLeftDir_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pinRightDir_net;
	wire [0:0] tmpFB_0__pinRightDir_net;
	wire [0:0] tmpIO_0__pinRightDir_net;
	wire [0:0] tmpINTERRUPT_0__pinRightDir_net;
	electrical [0:0] tmpSIOVREF__pinRightDir_net;

	cy_psoc3_pins_v1_10
		#(.id("aa1f56ee-6706-4845-9e3e-ef9cce1cdbfe"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .width(1))
		pinRightDir
		 (.oe(tmpOE__pinRightDir_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__pinRightDir_net[0:0]}),
		  .io({tmpIO_0__pinRightDir_net[0:0]}),
		  .siovref(tmpSIOVREF__pinRightDir_net),
		  .interrupt({tmpINTERRUPT_0__pinRightDir_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pinRightDir_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pinLeftSleep_net;
	wire [0:0] tmpFB_0__pinLeftSleep_net;
	wire [0:0] tmpIO_0__pinLeftSleep_net;
	wire [0:0] tmpINTERRUPT_0__pinLeftSleep_net;
	electrical [0:0] tmpSIOVREF__pinLeftSleep_net;

	cy_psoc3_pins_v1_10
		#(.id("d8d0d751-d90a-4172-bbf9-d0202ba4c197"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .width(1))
		pinLeftSleep
		 (.oe(tmpOE__pinLeftSleep_net),
		  .y({Net_119}),
		  .fb({tmpFB_0__pinLeftSleep_net[0:0]}),
		  .io({tmpIO_0__pinLeftSleep_net[0:0]}),
		  .siovref(tmpSIOVREF__pinLeftSleep_net),
		  .interrupt({tmpINTERRUPT_0__pinLeftSleep_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pinLeftSleep_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pinRightSleep_net;
	wire [0:0] tmpFB_0__pinRightSleep_net;
	wire [0:0] tmpIO_0__pinRightSleep_net;
	wire [0:0] tmpINTERRUPT_0__pinRightSleep_net;
	electrical [0:0] tmpSIOVREF__pinRightSleep_net;

	cy_psoc3_pins_v1_10
		#(.id("818a1fcc-f262-4949-9b99-488e4180f919"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .width(1))
		pinRightSleep
		 (.oe(tmpOE__pinRightSleep_net),
		  .y({Net_124}),
		  .fb({tmpFB_0__pinRightSleep_net[0:0]}),
		  .io({tmpIO_0__pinRightSleep_net[0:0]}),
		  .siovref(tmpSIOVREF__pinRightSleep_net),
		  .interrupt({tmpINTERRUPT_0__pinRightSleep_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pinRightSleep_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Timer_v2_50_3 TIMER_ThreadTimer (
        .reset(Net_12),
        .interrupt(Net_143),
        .enable(1'b1),
        .trigger(1'b0),
        ...
        .tc(Net_180),
        .clock(Net_175));
    defparam TIMER_ThreadTimer.CaptureCount = 2;
    defparam TIMER_ThreadTimer.CaptureCounterEnabled = 0;
    defparam TIMER_ThreadTimer.DeviceFamily = "PSoC4";
    defparam TIMER_ThreadTimer.InterruptOnCapture = 0;
    defparam TIMER_ThreadTimer.InterruptOnTC = 1;
    defparam TIMER_ThreadTimer.Resolution = 8;
    defparam TIMER_ThreadTimer.SiliconRevision = "17";
